class TurnCycle {
  ...
  async turn() {
    ...
    //Stop here if we are replacing this teacher
    if (submission.replacement) {
      ...
      await this.onNewEvent({
        type: "textMessage",
        text: `Sumbaga nang ulo, ${submission.replacement.name}!`
      })
      this.nextTurn();
      return;
    }
    ...
    if (targetDead) {
      ...
      if (submission.target.team === "enemy") {
        ...
        const playerActiveTeacherId = this.battle.activeCombatants.player;
        ...
        await this.onNewEvent({
          type: "giveXp",
          xp,
          combatant: this.battle.combatants[playerActiveTeacherId]
        })
      }
    }
